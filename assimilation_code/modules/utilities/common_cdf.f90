...
!=======================================================================
!
! [PURPOSE:] Functions for Normal Cumulative Density Function (CDF)
!
...
!=======================================================================
  IMPLICIT NONE
  PUBLIC !:: alnorm, r8_normal_01_cdf_inverse, r8poly_value

END MODULE common_cdf

SUBROUTINE cal_alnorm ( x, upper,out_var ) ! KKUROSAWA
 ...
 ! INTEGER,INTENT(IN) :: test_num
  real ( kind = 8 ),INTENT(OUT) :: out_var
...
!  if ( .not. up ) then
  if ( up ) then ! KKUROSAWA
    alnorm = 1.0D+00 - alnorm
  end if

  out_var = alnorm
  return
end SUBROUTINE cal_alnorm
