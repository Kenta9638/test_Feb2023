function values = nc_varget_mexnc(ncfile,varname,varargin)
...
try
    ...
    values = handle_fill_value(ncid,varid,var_type,values);
    values = handle_missing_value(ncid,varid,var_type,values);
