...
%%close all;
  ...
  DIR    = '/data_kotsuki01/kurosawa/ICE_FLAG/figure/Kanemarusan/20180906_DFR_Roh';
  rho_s  = ["005" "010" "015" "020" "025"];
  rho_g  = ["030" "040" "050"];
  var1   = ["Ka" "Ku"];
  var2   = ["snow" "grpl" "rain"];
...
%  end
  ...
  out_Ku{4} = snow_Ku_015;  out_DFR{4} = snow_DFR_015;
  out_Ku{5} = snow_Ku_020;  out_DFR{5} = snow_DFR_020;
  out_Ku{6} = snow_Ku_025;  out_DFR{6} = snow_DFR_025;
  out_Ku{7} = grpl_Ku_030;  out_DFR{7} = grpl_DFR_030;
  out_Ku{8} = grpl_Ku_040;  out_DFR{8} = grpl_DFR_040;
  out_Ku{9} = grpl_Ku_050;  out_DFR{9} = grpl_DFR_050;
